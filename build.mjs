...
const copy = {
  ru: {
    ...
    metaDescription: 'Ответьте на вопросы о бизнесе и бесплатно получите персональную рекламную стратегию. Без карты, подключения Meta и API-ключей.',
    ...
    heroLead: 'Ответьте на вопросы о бизнесе в Telegram. AdPilot разберёт оффер, аудиторию и путь клиента, затем покажет персональную рекламную стратегию и объяснит каждое решение.',
    ...
    heroFacts: ['Персональный разбор', '19 нишевых баз знаний', '10–15 минут'],
    chat: {
      online: 'онлайн',
      ...
      settings: '<strong>Бесплатный стратегический разбор</strong><br>Цель: сообщения в Instagram<br>Ядро: женщины 20–40 · Варшава',
    ...
    trust: [
      ...
      ['19 категорий бизнеса', 'Рекомендации с учётом ниши'],
    ...
    steps: [
      ...
      ['Получите бесплатный разбор', 'Вы увидите сильные стороны, главные пробелы, рекомендуемую цель, аудиторию, географию и рекламный угол — без подключения Meta.'],
    ...
    faqs: [
      ...
      ['Что именно я получу бесплатно?', 'Персональное интервью и стратегический разбор: карту бизнеса, сильные стороны и пробелы, рекомендуемую цель, точку назначения, аудиторию, географию, бюджетный ориентир и главный рекламный угол. Карта, Meta и API-ключи не нужны.'],
  ...
  en: {
    ...
    metaDescription: 'Answer a focused business interview and receive a personalised advertising direction for free. No card, ad-account connection or API keys.',
    ...
    heroLead: 'Answer focused questions in Telegram. AdPilot analyses your offer, audience and conversion path, then shows a personalised advertising direction and explains each decision.',
    primary: 'Get my free business review', secondary: 'See how it works',
    previewNote: 'No card · no Meta connection · no API keys',
    heroFacts: ['Personalised review', '19 niche knowledge bases', '10–15 minutes'],
    chat: {
      online: 'online',
      ...
      settings: '<strong>Free strategic review</strong><br>Direction: Instagram messages<br>Core audience: women 20–40 · Warsaw',
    ...
    trust: [['Before payment', 'Strategy without connecting an ad account'], ['19 business categories', 'Recommendations grounded in the niche'], ['€150 per month', 'Full access only after your decision'], ['Approval required', 'Launch and budget remain under your control']],
    ...
    steps: [['Complete the expert interview', 'Answer questions about your offer, customers, economics, geography and enquiry path. AdPilot explains why each answer matters.'], ['Receive a free strategic review', 'See strengths, critical gaps, the recommended objective, destination, audience, geography and advertising angle — without connecting Meta.'], ['Unlock the full AdPilot', 'After subscribing, you receive the full plan, ads, creative tools, API launch, monitoring and reports.']],
  ...
  pl: {
    ...
    metaDescription: 'Odpowiedz na pytania o firmę i bezpłatnie otrzymaj spersonalizowany kierunek reklamy. Bez karty, podłączania Meta i kluczy API.',
    ...
    heroLead: 'Odpowiedz na konkretne pytania w Telegramie. AdPilot przeanalizuje ofertę, odbiorców i ścieżkę zapytania, a następnie pokaże spersonalizowany kierunek reklamy i wyjaśni każdą decyzję.',
    ...
    heroFacts: ['Spersonalizowana analiza', '19 baz wiedzy branżowej', '10–15 minut'],
    chat: {
      online: 'online',
      ...
      settings: '<strong>Bezpłatna analiza strategiczna</strong><br>Kierunek: wiadomości na Instagramie<br>Rdzeń grupy: kobiety 20–40 · Warszawa',
    ...
    trust: [['Przed płatnością', 'Strategia bez podłączania konta'], ['19 kategorii biznesu', 'Rekomendacje oparte na branży'], ['€150 miesięcznie', 'Pełny dostęp po Twojej decyzji'], ['Po zatwierdzeniu', 'Start i budżet pod Twoją kontrolą']],
    ...
    steps: [['Przejdź wywiad ekspercki', 'Odpowiedz na pytania o produkt, klientów, ekonomię, geografię i sposób pozyskiwania zapytań. AdPilot wyjaśnia, dlaczego każda odpowiedź ma znaczenie.'], ['Odbierz bezpłatną analizę', 'Zobacz mocne strony, kluczowe braki, zalecany cel, miejsce docelowe, grupę, geografię i kąt reklamowy — bez podłączania Meta.'], ['Odblokuj pełny AdPilot', 'Po opłaceniu abonamentu otrzymujesz pełny plan, reklamy, narzędzia kreacji, uruchomienie przez API, monitoring i raporty.']],
  ...
  uk: {
    ...
    metaDescription: 'Дайте відповіді про бізнес і безкоштовно отримайте персоналізований напрям реклами. Без картки, підключення Meta та API-ключів.',
    ...
    heroLead: 'Дайте відповіді на конкретні запитання в Telegram. AdPilot проаналізує пропозицію, аудиторію та шлях заявки, а потім покаже персоналізований напрям реклами й пояснить кожне рішення.',
    ...
    heroFacts: ['Персоналізований розбір', '19 нішевих баз знань', '10–15 хвилин'],
    chat: {
      online: 'онлайн',
      ...
      settings: '<strong>Безкоштовний стратегічний розбір</strong><br>Напрям: повідомлення в Instagram<br>Ядро аудиторії: жінки 20–40 · Варшава',
    ...
    trust: [['До оплати', 'Стратегія без підключення кабінету'], ['19 категорій бізнесу', 'Рекомендації з урахуванням ніші'], ['€150 на місяць', 'Повний доступ після вашого рішення'], ['Після підтвердження', 'Запуск і бюджет під вашим контролем']],
