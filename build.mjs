...
const copy = {
  ru: {
    ...
    offerNote: 'Без карты · без подключения Meta и TikTok · полный доступ — €150 за 30 дней',
    ...
    trust: [
      ...
      ['Без карты', 'Никакой автоматической оплаты'],
      ['Без рекламного кабинета', 'Meta и TikTok подключаются только после оплаты'],
      ['€150 / 30 дней', 'Полная система запуска и контроля']
    ],
    ...
    steps: [
      ...
      ['Откройте полную систему, если план подходит', 'После оплаты €150 вы получаете 30 дней доступа к точным настройкам, объявлениям, запуску и контролю кампаний.']
    ],
    ...
    priceLead: 'Бесплатно получите направление. Если оно подходит — откройте на 30 дней полный цикл от настроек до контроля результатов.',
    perMonth: '/ 30 дней',
    ...
    exclusions: 'Рекламный бюджет оплачивается отдельно. Генерация изображений и видео расходует включённые AI-кредиты; стоимость показывается до запуска. Продление не автоматическое.',
    ...
    faqs: [
      ...
      ['€150 — это ежемесячная подписка?', 'Оплата открывает доступ на 30 дней. Автоматического продления нет: следующий период вы оплачиваете отдельно, если хотите продолжить.'],
    ...
    legal: 'HABELEV STANISLAV · €150 за 30 дней доступа · рекламный бюджет оплачивается отдельно.'
  },
  en: {
    langName: 'English',
    ...
    offerNote: 'No card · no Meta or TikTok connection · full access is €150 for 30 days',
    ...
    trust: [['Free', 'A personalised plan from your answers'], ['No card', 'No automatic charge'], ['No ad account', 'Connect Meta or TikTok only after payment'], ['€150 / 30 days', 'The full launch and control system']],
    ...
    priceKicker: 'Pricing', priceTitle: 'Turn your review into a working campaign', priceLead: 'Get direction for free. If it fits, unlock the full cycle from settings to performance control for 30 days.', perMonth: '/ 30 days', previewBadge: 'Free review before payment',
    priceItems: ['Exact audience, geography, budget and CTA settings', 'Meta and TikTok campaign creation', 'Ad variants and visual-generation tools', '100 AI credits for 30 days', 'Performance checks every 6 hours and reports', 'Critical changes only after approval', 'In-bot support'], exclusions: 'Ad spend is separate. Image and video generation uses the included AI credits, with the cost shown before generation. Renewal is not automatic.', priceButton: 'Get the free review first',
    faqKicker: 'FAQ', faqTitle: 'What you should know before starting',
    faqs: [['What exactly do I receive for free?', 'A personalised business diagnosis, first priority segment, positioning angle, funnel bottleneck, recommended objective and first strategic move. No campaign launch or ad-account connection.'], ['What unlocks after payment?', 'Full campaign settings, ads, visual-generation tools, Meta and TikTok connection, launch, reports and optimisation proposals.'], ['Is €150 an automatically renewing subscription?', 'The payment opens access for 30 days. There is no automatic renewal; you pay for the next period separately if you choose to continue.'], ['How do AI credits work?', 'Each 30-day period includes 100 credits, an internal $15 AI-generation allowance. The bot displays the credit cost before creating an image or video.'], ['Do I share my password?', 'No. The free review needs no ad account. After payment, Meta and TikTok connect through official authorisation without sharing your password with AdPilot.'], ['Does AdPilot guarantee sales?', 'AdPilot does not guarantee an exact number of sales in advance. Results depend on the offer, market, budget and data. The system builds and manages the launch around enquiries and payments.']],
    ...
    footerLinks: ['Privacy', 'Terms', 'Company details', 'Contact'], legal: 'HABELEV STANISLAV · €150 for 30 days of access · ad spend is separate.'
  },
  pl: {
    ...
    trust: [['Bezpłatnie', 'Spersonalizowany plan z Twoich odpowiedzi'], ['Bez karty', 'Bez automatycznej opłaty'], ['Bez konta reklamowego', 'Meta i TikTok łączysz dopiero po płatności'], ['€150 / 30 dni', 'Pełny system uruchomienia i kontroli']],
    ...
    steps: [['Opowiedz o firmie', 'Odpowiedz na pytania o ofertę, klientów, lokalizację i sposób pozyskiwania zapytań. Zwykle zajmuje to 10–15 minut.'], ['Odbierz spersonalizowany plan', 'AI pokaże diagnozę firmy, pierwszy segment, kąt pozycjonowania, wąskie gardło lejka i pierwszy ruch strategiczny.'], ['Odblokuj pełny system, jeśli plan pasuje', 'Płatność €150 otwiera na 30 dni dokładne ustawienia, tworzenie reklam, uruchomienie kampanii i dalszą kontrolę.']],
    ...
    priceKicker: 'Cena', priceTitle: 'Zamień analizę w działającą kampanię', priceLead: 'Odbierz kierunek bezpłatnie. Jeśli pasuje, odblokuj na 30 dni pełny cykl od ustawień po kontrolę wyników.', perMonth: '/ 30 dni', previewBadge: 'Bezpłatna analiza przed płatnością', priceItems: ['Dokładna grupa, geografia, budżet i CTA', 'Tworzenie kampanii Meta i TikTok', 'Warianty reklam i narzędzia do wizualizacji', '100 kredytów AI na 30 dni', 'Kontrola wyników co 6 godzin i raporty', 'Krytyczne zmiany tylko po zatwierdzeniu', 'Wsparcie w bocie'], exclusions: 'Budżet reklamowy jest rozliczany osobno. Obrazy i wideo zużywają zawarte kredyty AI, a koszt widzisz przed generowaniem. Odnowienie nie jest automatyczne.', priceButton: 'Najpierw odbierz bezpłatną analizę',
    faqKicker: 'Pytania', faqTitle: 'Najważniejsze informacje przed startem', faqs: [['Co dokładnie otrzymam bezpłatnie?', 'Spersonalizowaną diagnozę firmy, pierwszy segment, kąt pozycjonowania, wąskie gardło lejka, rekomendowany cel i pierwszy krok strategiczny. Bez uruchomienia reklamy i łączenia konta.'], ['Co odblokowuje płatność?', 'Pełne ustawienia kampanii, reklamy, narzędzia do tworzenia wizualizacji, połączenie Meta i TikTok, start, raporty i propozycje optymalizacji.'], ['Czy €150 odnawia się automatycznie?', 'Płatność otwiera dostęp na 30 dni. Nie ma automatycznego odnowienia — kolejny okres opłacasz osobno, jeśli chcesz kontynuować.'], ['Jak działają kredyty AI?', 'Każde 30 dni zawiera 100 kredytów, czyli wewnętrzny limit $15 na generowanie AI. Bot pokazuje koszt przed utworzeniem obrazu lub wideo.'], ['Czy przekazuję hasło?', 'Nie. Bezpłatna analiza nie wymaga konta reklamowego. Po płatności Meta i TikTok łączysz przez oficjalną autoryzację bez przekazywania hasła AdPilot.'], ['Czy AdPilot gwarantuje sprzedaż?', 'AdPilot nie gwarantuje dokładnej liczby sprzedaży z góry. Wynik zależy od oferty, rynku, budżetu i danych. System buduje i prowadzi start wokół zapytań i płatności.']],
    finalKicker: 'Wartość przed płatnością', finalTitle: 'Odbierz plan dla swojej firmy. Potem zdecyduj o płatności', finalLead: 'Odpowiedz na pytania w Telegramie i sprawdź, od którego segmentu, obietnicy i ruchu reklamowego zacząć. Bez karty i konta reklamowego.', finalButton: 'Odbierz bezpłatną analizę AI', footerLinks: ['Prywatność', 'Warunki', 'Dane firmy', 'Kontakt'], legal: 'HABELEV STANISLAV · €150 za 30 dni dostępu · budżet reklamowy osobno.'
  },
  uk: {
    ...
    skip: 'Перейти до вмісту', menu: 'Відкрити меню', nav: ['Як це працює', 'Можливості', 'Безпека', 'Ціна', 'Питання'], navTry: 'Отримати розбір', heroBadge: 'Безкоштовний AI-розбір бізнесу для Meta і TikTok', heroTitle: 'Дізнайтеся, з якої реклами почати вашому бізнесу', heroLead: 'AI-стратег проведе професійне інтерв’ю та покаже, кого залучати першим, з якою обіцянкою виходити в рекламу, де губляться клієнти і що робити далі.', primary: 'Отримати безкоштовний розбір', secondary: 'Подивитися, як працює', offerNote: 'Без картки · без підключення Meta і TikTok · повний доступ €150 на 30 днів', heroFacts: ['Персонально за вашими відповідями', '10–15 хвилин у Telegram', 'Без рекламного бюджету'],
    ...
    trust: [['Безкоштовно', 'Персональний план із ваших відповідей'], ['Без картки', 'Без автоматичного списання'], ['Без рекламного акаунта', 'Meta і TikTok лише після оплати'], ['€150 / 30 днів', 'Повна система запуску й контролю']],
    howKicker: 'Як це працює', howTitle: 'Спочатку отримайте користь. Потім вирішуйте щодо повного запуску', howLead: 'До оплати AdPilot не просить картку, рекламний акаунт чи доступ до ваших даних Meta і TikTok.', steps: [['Розкажіть про бізнес', 'Дайте відповіді про продукт, клієнтів, географію та спосіб отримання заявок. Зазвичай це займає 10–15 хвилин.'], ['Отримайте персональний план', 'AI покаже діагноз бізнесу, перший сегмент, кут позиціонування, вузьке місце воронки та перший стратегічний крок.'], ['Відкрийте повну систему, якщо план підходить', 'Оплата €150 відкриває на 30 днів точні налаштування, створення реклами, запуск кампаній і подальший контроль.']],
    ...
    priceKicker: 'Ціна', priceTitle: 'Перетворіть розбір на робочу кампанію', priceLead: 'Безкоштовно отримайте напрямок. Якщо він підходить — відкрийте на 30 днів повний цикл від налаштувань до контролю результатів.', perMonth: '/ 30 днів', previewBadge: 'Безкоштовний розбір до оплати', priceItems: ['Точна аудиторія, географія, бюджет і CTA', 'Створення кампаній Meta і TikTok', 'Варіанти оголошень та інструменти для візуалів', '100 AI-кредитів на 30 днів', 'Перевірка показників кожні 6 годин і звіти', 'Критичні зміни лише після підтвердження', 'Підтримка всередині бота'], exclusions: 'Рекламний бюджет оплачується окремо. Зображення й відео витрачають включені AI-кредити; вартість показується до генерації. Продовження не автоматичне.', priceButton: 'Спочатку отримати безкоштовний розбір',
    faqKicker: 'Питання', faqTitle: 'Коротко про важливе перед початком', faqs: [['Що саме я отримаю безкоштовно?', 'Персональний діагноз бізнесу, перший пріоритетний сегмент, кут позиціонування, вузьке місце воронки, рекомендовану ціль і перший стратегічний крок. Без запуску реклами й підключення кабінету.'], ['Що відкривається після оплати?', 'Повні налаштування кампанії, оголошення, інструменти створення візуалів, підключення Meta і TikTok, запуск, звіти та пропозиції оптимізації.'], ['€150 — це автоматична підписка?', 'Оплата відкриває доступ на 30 днів. Автоматичного продовження немає: наступний період ви оплачуєте окремо, якщо хочете продовжити.'], ['Як працюють AI-кредити?', 'На кожні 30 днів включено 100 кредитів — внутрішній ліміт $15 на AI-генерацію. Бот показує вартість до створення зображення або відео.'], ['Чи потрібно передавати пароль?', 'Ні. Безкоштовний розбір не потребує рекламного акаунта. Після оплати Meta і TikTok підключаються через офіційну авторизацію без передачі пароля AdPilot.'], ['Чи гарантує AdPilot продажі?', 'AdPilot не гарантує точну кількість продажів наперед. Результат залежить від пропозиції, ринку, бюджету й даних. Система будує запуск навколо заявок та оплат і допомагає керувати ним.']],
    finalKicker: 'Користь до оплати', finalTitle: 'Отримайте план для свого бізнесу. Потім вирішуйте щодо оплати', finalLead: 'Дайте відповіді в Telegram і побачте, з якого сегмента, обіцянки та рекламного кроку варто почати. Без картки й рекламного акаунта.', finalButton: 'Отримати безкоштовний AI-розбір', footerLinks: ['Конфіденційність', 'Умови', 'Реквізити', 'Контакт'], legal: 'HABELEV STANISLAV · €150 за 30 днів доступу · рекламний бюджет оплачується окремо.'
  }
};
...
const legalCopy = {
  ru: {
    ...
    termsSections: [
      ...
      ['Бесплатный разбор и платный доступ', 'Персональный стратегический разбор доступен без карты и подключения рекламного кабинета. Оплата €150 открывает функции полной системы на 30 дней. Автоматического продления нет. Рекламный бюджет оплачивается отдельно; на 30 дней включено 100 AI-кредитов, стоимость операций показывается до генерации.'],
      ...
      ['Продление и доступность', 'Следующий 30-дневный период можно не оплачивать. Работа отдельных функций может временно зависеть от доступности Meta, TikTok, Telegram, Stripe, AI-моделей и других поставщиков. По вопросам поддержки: @sgabelev в Telegram.']
    ]
  },
  en: {
    ...
    termsSections: [
      ...
      ['Free review and paid access', 'The personalised strategic review needs no card or ad-account connection. A €150 payment opens the full system for 30 days. Renewal is not automatic. Ad spend is separate; 100 AI credits are included for 30 days, and each operation shows its cost before generation.'],
      ...
      ['Renewal and availability', 'You may choose not to pay for another 30-day period. Features may temporarily depend on Meta, TikTok, Telegram, Stripe, AI models and other providers. Support: @sgabelev on Telegram.']
    ]
  },
  pl: {
    ...
    termsSections: [
      ...
      ['Bezpłatna analiza i płatny dostęp', 'Spersonalizowana analiza strategiczna nie wymaga karty ani konta reklamowego. Płatność €150 otwiera pełny system na 30 dni. Odnowienie nie jest automatyczne. Budżet reklamowy jest osobny; na 30 dni otrzymujesz 100 kredytów AI, a koszt operacji widzisz przed generowaniem.'],
      ...
      ['Odnowienie i dostępność', 'Możesz nie opłacać kolejnego 30-dniowego okresu. Funkcje mogą czasowo zależeć od Meta, TikTok, Telegram, Stripe, modeli AI i innych dostawców. Wsparcie: @sgabelev w Telegramie.']
    ]
  },
  uk: {
    ...
    termsSections: [
      ...
      ['Безкоштовний розбір і платний доступ', 'Персональний стратегічний розбір не потребує картки чи рекламного акаунта. Оплата €150 відкриває повну систему на 30 днів. Автоматичного продовження немає. Рекламний бюджет оплачується окремо; на 30 днів включено 100 AI-кредитів, а вартість операцій показується до генерації.'],
      ...
      ['Продовження й доступність', 'Ви можете не оплачувати наступний 30-денний період. Функції можуть тимчасово залежати від Meta, TikTok, Telegram, Stripe, AI-моделей та інших постачальників. Підтримка: @sgabelev у Telegram.']
    ]
  }
};
