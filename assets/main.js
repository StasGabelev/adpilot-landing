...
const T = {
  ru: {
    ...
    faq3_a: "Триал — 7 дней, бесплатно, карта не нужна. В триале вы подключаете свой ключ OpenRouter API (openrouter.ai) — стоимость одной AI-генерации ~$0.10–0.50, это единственный ваш расход. После триала: $49/месяц — всё включено: AI, автопилот, отчёты. Плюс ваш рекламный бюджет напрямую в Meta.",
    ...
    cta_note: "7 дней бесплатно · Без карты · Затем $49/мес · Отмена в любой момент",
    tt_soon: "СКОРО",
    tt_text: "Реклама в TikTok — уже в разработке. Тот же AI-автопилот, те же сценарии, новая аудитория.",
  ...
  uk: {
    ...
    faq3_a: "Триал — 7 днів, безкоштовно, картка не потрібна. У триалі ви підключаєте свій ключ OpenRouter API (openrouter.ai) — вартість однієї AI-генерації ~$0.10–0.50, це єдиний ваш витрат. Після триалу: $49/місяць — все включено: AI, автопілот, звіти. Плюс ваш рекламний бюджет напряму в Meta.",
    ...
    cta_note: "7 днів безкоштовно · Без картки · Потім $49/міс · Скасування будь-коли",
    tt_soon: "СКОРО",
    tt_text: "Реклама в TikTok — вже в розробці. Той самий AI-автопілот, ті самі сценарії, нова аудиторія.",
  ...
  en: {
    ...
    faq3_a: "Trial is 7 days free — no card needed. During the trial you connect your own OpenRouter API key (openrouter.ai), which costs ~$0.10–0.50 per AI generation — that's your only expense. After the trial: $49/month with everything included: AI, autopilot, reports. Plus your Meta ad budget paid directly to Meta.",
    ...
    cta_note: "7 days free · No card required · Then $49/mo · Cancel anytime",
    tt_soon: "COMING SOON",
    tt_text: "TikTok Ads — already in development. Same AI autopilot, same scripts, brand new audience.",
    tt_stay: "Stay tuned →",
  ...
  pl: {
    ...
    faq3_a: "Trial — 7 dni bezpłatnie, karta nie jest wymagana. W okresie próbnym podłączasz własny klucz OpenRouter API (openrouter.ai) — koszt jednej generacji AI to ~$0.10–0.50, to jedyny Twój wydatek. Po trialu: $49/miesiąc — wszystko w cenie: AI, autopilot, raporty. Plus Twój budżet reklamowy bezpośrednio do Meta.",
    ...
    cta_note: "7 dni za darmo · Bez karty · Potem $49/mies · Anuluj kiedy chcesz",
    tt_soon: "WKRÓTCE",
    tt_text: "Reklamy w TikTok — już w trakcie tworzenia. Ten sam autopilot AI, te same scenariusze, nowa publiczność.",
