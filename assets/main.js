...
const T = {
  ru: {
    ...
    f4_text: "AdPilot создаёт готовые визуальные креативы: баннеры для Facebook, Stories и Reels для Instagram. Текст + дизайн + видео — одним запросом в Telegram.",
    ...
    pr_f3: "✅ AI-генерация фото-креативов",
    pr_f4: "✅ AI-генерация видео-роликов (Stories, Reels)",
  ...
  uk: {
    ...
    f4_text: "AdPilot створює готові візуальні креативи: банери для Facebook, Stories та Reels для Instagram. Текст + дизайн + відео — одним запитом у Telegram.",
    ...
    pr_f3: "✅ AI-генерація фото-креативів",
    pr_f4: "✅ AI-генерація відео-роликів (Stories, Reels)",
  ...
  en: {
    ...
    f4_text: "AdPilot generates ready-to-use visual creatives: photo banners for Facebook, Stories and Reels for Instagram. Text + design + video — from a single Telegram request.",
    ...
    pr_f3: "✅ AI photo creative generation",
    pr_f4: "✅ AI video generation (Stories, Reels)",
  ...
  pl: {
    ...
    f4_text: "AdPilot tworzy gotowe kreacje wizualne: banery na Facebook, Stories i Reels na Instagram. Tekst + projekt graficzny + wideo — jednym poleceniem w Telegramie.",
    ...
    pr_f3: "✅ AI generowanie kreacji foto",
    pr_f4: "✅ AI generowanie wideo (Stories, Reels)",
