...
const T = {
  ru: {
    ...
    f4_title: "База знаний, которая растёт",
    f4_text: "Лучшие тексты каждой ниши сохраняются в базу. Ваши следующие кампании получают проверенные формулы — система умнеет с каждым запуском.",
    ...
    pr_per: "/месяц",
    pr_extra1: "+ рекламный бюджет Meta (ваш, напрямую)",
    pr_extra2: "+ OpenRouter API ~$0.10–0.50 на кампанию",
    pr_f1: "✅ Неограниченное количество кампаний",
    pr_f2: "✅ Автопилот 24/7 — мониторинг каждые 6 часов",
    pr_f3: "✅ Ежедневные отчёты в Telegram",
    pr_f4: "✅ A/B тестирование с автовыбором победителя",
    pr_f5: "✅ Авто-оптимизация (пауза / масштаб / ротация)",
    pr_f6: "✅ Неограниченное количество проектов",
    pr_f7: "✅ 19 ниш бизнеса с AI-знаниями",
    pr_f8: "✅ Ретаргетинг и лид-формы",
    pr_vs: "Сравните: агентство берёт $500–2000/мес за один аккаунт",
    pr_btn: "🚀 Начать — первая кампания бесплатно",
    pr_note: "Без карты при старте · Отмена в любой момент",
    // Social Proof
    ...
    faq3_a: "Подписка AdPilot — $49/месяц. Дополнительно вы платите за рекламный бюджет напрямую в Meta (устанавливаете сами) и за AI-запросы через OpenRouter (~$0.10–0.50 на одну кампанию). Первая кампания создаётся бесплатно — карта не нужна.",
    ...
    faq6_q: "Что такое OpenRouter API и нужно ли его настраивать?",
    faq6_a: "OpenRouter — это платформа, через которую AdPilot обращается к AI-моделям (Claude, Gemini, GPT-4). Вы создаёте аккаунт на openrouter.ai, пополняете баланс и вставляете API-ключ в бот. Стоимость одной кампании — около $0.10–0.50. Вы полностью контролируете расходы.",
  ...
  uk: {
    ...
    f4_title: "База знань, яка зростає",
    f4_text: "Кращі тексти кожної ніші зберігаються в базу. Наступні кампанії отримують перевірені формули — система розумнішає з кожним запуском.",
    ...
    pr_per: "/місяць",
    pr_extra1: "+ рекламний бюджет Meta (ваш, напряму)",
    pr_extra2: "+ OpenRouter API ~$0.10–0.50 на кампанію",
    pr_f1: "✅ Необмежена кількість кампаній",
    pr_f2: "✅ Автопілот 24/7 — моніторинг кожні 6 годин",
    pr_f3: "✅ Щоденні звіти у Telegram",
    pr_f4: "✅ A/B тестування з автовибором переможця",
    pr_f5: "✅ Авто-оптимізація (пауза / масштаб / ротація)",
    pr_f6: "✅ Необмежена кількість проектів",
    pr_f7: "✅ 19 ніш бізнесу з AI-знаннями",
    pr_f8: "✅ Ретаргетинг та лід-форми",
    pr_vs: "Порівняйте: агентство бере $500–2000/міс за один кабінет",
    pr_btn: "🚀 Почати — перша кампанія безкоштовно",
    pr_note: "Без карти при старті · Скасування будь-коли",
    // Social Proof
    ...
    faq3_a: "Підписка AdPilot — $49/місяць. Додатково ви платите за рекламний бюджет напряму в Meta та за AI-запити через OpenRouter (~$0.10–0.50 на кампанію). Перша кампанія — безкоштовно, картка не потрібна.",
    ...
    faq6_q: "Що таке OpenRouter API і чи потрібно його налаштовувати?",
    faq6_a: "OpenRouter — це платформа, через яку AdPilot звертається до AI-моделей (Claude, Gemini, GPT-4). Ви створюєте акаунт на openrouter.ai, поповнюєте баланс і вставляєте API-ключ у бот. Вартість однієї кампанії — близько $0.10–0.50.",
  ...
  en: {
    ...
    f4_title: "A Knowledge Base That Grows",
    f4_text: "Top headlines per niche enter a global pool. New campaigns get proven formulas — the system learns from every run.",
    ...
    pr_per: "/month",
    pr_extra1: "+ Meta ad spend (your budget, paid directly to Meta)",
    pr_extra2: "+ OpenRouter API ~$0.10–0.50 per campaign",
    pr_f1: "✅ Unlimited campaigns",
    pr_f2: "✅ 24/7 autopilot — monitoring every 6 hours",
    pr_f3: "✅ Daily reports in Telegram",
    pr_f4: "✅ A/B testing with auto-winner selection",
    pr_f5: "✅ Auto-optimization (pause / scale / rotate)",
    pr_f6: "✅ Unlimited projects",
    pr_f7: "✅ 19 business niches with AI expertise",
    pr_f8: "✅ Retargeting and lead forms",
    pr_vs: "Compare: agencies charge $500–2000/month for a single account",
    pr_btn: "🚀 Start — first campaign free",
    pr_note: "No card at signup · Cancel anytime",
    // Social Proof
    ...
    faq3_a: "AdPilot subscription is $49/month. Additionally you pay for your ad budget directly to Meta (you set the amount) and for AI requests via OpenRouter (~$0.10–0.50 per campaign). Your first campaign is created free — no card needed.",
    ...
    faq6_q: "What is OpenRouter API and do I need to set it up?",
    faq6_a: "OpenRouter is the platform AdPilot uses to access AI models (Claude, Gemini, GPT-4). You create an account at openrouter.ai, add funds, and paste your API key into the bot. Cost per campaign is ~$0.10–0.50. You're in full control of your AI spending.",
  ...
  pl: {
    ...
    f4_title: "Baza wiedzy, która rośnie",
    f4_text: "Najlepsze teksty każdej niszy trafiają do globalnej puli. Nowe kampanie dostają sprawdzone formuły — system uczy się z każdego uruchomienia.",
    ...
    pr_per: "/miesiąc",
    pr_extra1: "+ budżet reklamowy Meta (Twój, płatny bezpośrednio)",
    pr_extra2: "+ OpenRouter API ~$0.10–0.50 na kampanię",
    pr_f1: "✅ Nieograniczona liczba kampanii",
    pr_f2: "✅ Autopilot 24/7 — monitoring co 6 godzin",
    pr_f3: "✅ Codzienne raporty w Telegramie",
    pr_f4: "✅ Test A/B z automatycznym wyborem zwycięzcy",
    pr_f5: "✅ Auto-optymalizacja (pauza / skalowanie / rotacja)",
    pr_f6: "✅ Nieograniczona liczba projektów",
    pr_f7: "✅ 19 nisz biznesowych z wiedzą AI",
    pr_f8: "✅ Retargeting i formularze leadów",
    pr_vs: "Porównaj: agencja pobiera $500–2000/mies. za jedno konto",
    pr_btn: "🚀 Zacznij — pierwsza kampania bezpłatnie",
    pr_note: "Bez karty przy rejestracji · Anuluj kiedy chcesz",
    // Social Proof
    sp_tag: "TYPOWY START",
    ...
    faq3_a: "Abonament AdPilot — $49/miesiąc. Dodatkowo płacisz za budżet reklamowy bezpośrednio do Meta (ustalaasz sam) oraz za AI poprzez OpenRouter (~$0.10–0.50 za kampanię). Pierwsza kampania jest bezpłatna — karta nie jest potrzebna.",
    ...
    faq6_q: "Czym jest OpenRouter API i czy trzeba go konfigurować?",
    faq6_a: "OpenRouter to platforma, przez którą AdPilot korzysta z modeli AI (Claude, Gemini, GPT-4). Tworzysz konto na openrouter.ai, doładowujesz saldo i wklejasz klucz API do bota. Koszt jednej kampanii to ok. $0.10–0.50. Masz pełną kontrolę nad wydatkami.",
