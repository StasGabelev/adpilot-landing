...
const T = {
  ru: {
    ...
    hero_title_1: "Реклама в Meta и TikTok",
    hero_title_3: "пока вы работаете",
    hero_sub: "Опишите бизнес за 10 минут — AI напишет объявления, настроит аудитории и запустит кампанию в Meta и TikTok. Потом следит 24/7, оптимизирует и присылает отчёты каждое утро.",
    btn_start: "🚀 Начать бесплатно — 7 дней",
    ...
    rcb2_before: "Агентство", rcb2_old: "€500–2000/мес", rcb2_new: "€150/мес", rcb2_label: "вместо €500–2000 за агентство",
    ...
    f7_title: "TikTok Ads — уже встроено",
    f7_text: "Запускайте видео- и фото-рекламу в TikTok из того же бота, что и Meta. Один сценарий — два канала, без дублирования работы.",
    // AI Score
    ...
    pr_per: "/месяц",
    pr_trial_badge: "7 дней бесплатно · Карта не нужна",
    ...
    pr_note: "Без карты · 7 дней бесплатно · Затем €150/мес · Отмена в любой момент",
    // Social Proof
    ...
    ct_r1: "Подписка в месяц", ct_r1a: "€150/мес", ct_r1b: "€500–2000/мес", ct_r1c: "Бесплатно",
    ...
    t5_name: "TikTok Ads API", t5_desc: "Автозапуск видео и фото-рекламы",
    ...
    faq3_a: "Триал — 7 дней, бесплатно, карта не нужна. В триале вы подключаете свой ключ OpenRouter API (openrouter.ai) — стоимость одной AI-генерации ~$0.10–0.50, это единственный ваш расход. После триала: €150/месяц — всё включено: AI, автопилот, отчёты. Плюс ваш рекламный бюджет напрямую в Meta.",
    ...
    cta_title: "7 дней бесплатно — карта не нужна",
    cta_sub: "Подключи OpenRouter API ключ и начни прямо сейчас. Триал без ограничений, без карты.",
    cta_btn: "🚀 Начать бесплатный триал",
    cta_note: "7 дней бесплатно · Без карты · Затем €150/мес · Отмена в любой момент",
    tt_soon: "НОВОЕ",
    tt_text: "TikTok Ads уже в AdPilot — тот же AI-автопилот, новая аудитория. Следующие площадки — уже в разработке.",
    tt_stay: "Следите за обновлениями →",
  ...
  uk: {
    ...
    nav_pricing: "Ціни",
    badge: "Powered by Claude 4 · Gemini · GPT-4",
    hero_title_1: "Реклама в Meta та TikTok",
    hero_title_3: "поки ви працюєте",
    hero_sub: "Опишіть бізнес за 10 хвилин — AI напише оголошення, налаштує аудиторії та запустить кампанію в Meta та TikTok. Потім стежить 24/7, оптимізує і надсилає звіти щоранку.",
    btn_start: "🚀 Почати безкоштовно — 7 днів",
    ...
    rcb2_before: "Агентство", rcb2_old: "€500–2000/міс", rcb2_new: "€150/міс", rcb2_label: "замість €500–2000 за агентство",
    ...
    f7_title: "TikTok Ads — вже вбудовано",
    f7_text: "Запускайте відео- та фото-рекламу в TikTok з того самого бота, що й Meta. Один сценарій — два канали, без подвійної роботи.",
    // AI Score
    ...
    pr_per: "/місяць",
    pr_trial_badge: "7 днів безкоштовно · Картка не потрібна",
    ...
    pr_note: "Без картки · 7 днів безкоштовно · Потім €150/міс · Скасування будь-коли",
    // Social Proof
    ...
    ct_r1: "Підписка на місяць", ct_r1a: "€150/міс", ct_r1b: "€500–2000/міс", ct_r1c: "Безкоштовно",
    ...
    t5_name: "TikTok Ads API", t5_desc: "Автозапуск відео та фото-реклами",
    ...
    faq3_a: "Триал — 7 днів, безкоштовно, картка не потрібна. У триалі ви підключаєте свій ключ OpenRouter API (openrouter.ai) — вартість однієї AI-генерації ~$0.10–0.50, це єдиний ваш витрат. Після триалу: €150/місяць — все включено: AI, автопілот, звіти. Плюс ваш рекламний бюджет напряму в Meta.",
    ...
    cta_title: "7 днів безкоштовно — картка не потрібна",
    cta_sub: "Підключи ключ OpenRouter API і починай прямо зараз. Триал без обмежень, без картки.",
    cta_btn: "🚀 Розпочати безкоштовний триал",
    cta_note: "7 днів безкоштовно · Без картки · Потім €150/міс · Скасування будь-коли",
    tt_soon: "НОВЕ",
    tt_text: "TikTok Ads вже в AdPilot — той самий AI-автопілот, нова аудиторія. Наступні майданчики — вже в розробці.",
    tt_stay: "Стежте за оновленнями →",
  ...
  en: {
    ...
    nav_pricing: "Pricing",
    badge: "Powered by Claude 4 · Gemini · GPT-4",
    hero_title_1: "Meta & TikTok ads that",
    hero_title_3: "while you run your business",
    hero_sub: "Describe your business in 10 minutes — AI writes the ads, builds the audience, and launches the campaign on Meta and TikTok. Then it monitors 24/7, optimizes, and sends you a report every morning.",
    btn_start: "🚀 Start Free — 7 Days",
    ...
    rcb2_before: "Agency", rcb2_old: "€500–2000/mo", rcb2_new: "€150/mo", rcb2_label: "vs €500–2000 for an agency",
    ...
    f7_title: "TikTok Ads — Built In",
    f7_text: "Launch video and photo ads on TikTok from the same bot you use for Meta. One script, two channels — no duplicate work.",
    // AI Score
    ...
    pr_per: "/month",
    pr_trial_badge: "7 days free · No card required",
    ...
    pr_note: "No card required · 7 days free · Then €150/mo · Cancel anytime",
    // Social Proof
    ...
    ct_r1: "Monthly subscription", ct_r1a: "€150/mo", ct_r1b: "€500–2000/mo", ct_r1c: "Free",
    ...
    t5_name: "TikTok Ads API", t5_desc: "Auto-launches video & photo ads",
    ...
    faq3_a: "Trial is 7 days free — no card needed. During the trial you connect your own OpenRouter API key (openrouter.ai), which costs ~$0.10–0.50 per AI generation — that's your only expense. After the trial: €150/month with everything included: AI, autopilot, reports. Plus your Meta ad budget paid directly to Meta.",
    ...
    // CTA
    cta_tag: "START TODAY",
    cta_title: "7 days free — no card needed",
    cta_sub: "Connect your OpenRouter API key and start right now. Full trial, no card.",
    cta_btn: "🚀 Start Free Trial",
    cta_note: "7 days free · No card required · Then €150/mo · Cancel anytime",
    tt_soon: "NEW",
    tt_text: "TikTok Ads is live in AdPilot — same AI autopilot, brand new audience. More platforms are already in development.",
    tt_stay: "Stay tuned →",
  ...
  pl: {
    ...
    nav_pricing: "Cennik",
    badge: "Powered by Claude 4 · Gemini · GPT-4",
    hero_title_1: "Reklamy w Meta i TikTok",
    hero_title_3: "gdy Ty prowadzisz biznes",
    hero_sub: "Opisz swój biznes w 10 minut — AI napisze ogłoszenia, dobierze grupę docelową i uruchomi kampanię w Meta i TikTok. Potem pilnuje 24/7, optymalizuje i wysyła Ci raport co rano.",
    btn_start: "🚀 Zacznij za darmo — 7 dni",
    ...
    rcb2_before: "Agencja", rcb2_old: "€500–2000/mies", rcb2_new: "€150/mies", rcb2_label: "zamiast €500–2000 za agencję",
    ...
    f7_title: "TikTok Ads — już wbudowane",
    f7_text: "Uruchamiaj reklamy wideo i foto na TikToku z tego samego bota co Meta. Jeden scenariusz — dwa kanały, bez podwójnej pracy.",
    // AI Score
    ...
    pr_per: "/miesiąc",
    pr_trial_badge: "7 dni za darmo · Karta nie wymagana",
    ...
    pr_note: "Bez karty · 7 dni za darmo · Potem €150/mies · Anuluj kiedy chcesz",
    // Social Proof
    sp_tag: "TYPOWY START",
    ...
    ct_r1: "Abonament miesięczny", ct_r1a: "€150/mies", ct_r1b: "€500–2000/mies", ct_r1c: "Bezpłatnie",
    ...
    t5_name: "TikTok Ads API", t5_desc: "Auto-uruchamianie reklam wideo i foto",
    ...
    faq3_a: "Trial — 7 dni bezpłatnie, karta nie jest wymagana. W okresie próbnym podłączasz własny klucz OpenRouter API (openrouter.ai) — koszt jednej generacji AI to ~$0.10–0.50, to jedyny Twój wydatek. Po trialu: €150/miesiąc — wszystko w cenie: AI, autopilot, raporty. Plus Twój budżet reklamowy bezpośrednio do Meta.",
    ...
    cta_title: "7 dni za darmo — karta nie wymagana",
    cta_sub: "Podłącz klucz OpenRouter API i zacznij teraz. Pełny trial, bez karty.",
    cta_btn: "🚀 Rozpocznij bezpłatny trial",
    cta_note: "7 dni za darmo · Bez karty · Potem €150/mies · Anuluj kiedy chcesz",
    tt_soon: "NOWOŚĆ",
    tt_text: "TikTok Ads już w AdPilot — ten sam autopilot AI, nowa publiczność. Kolejne platformy są już w budowie.",
    tt_stay: "Śledź aktualizacje →",
